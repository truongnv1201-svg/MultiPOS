...
// ---------- Design tokens (đồng bộ ngôn ngữ chung của app) ----------
export const CARD = 'bg-white rounded-xl border border-slate-200 shadow-sm';
export const INPUT =
  'mt-1 w-full h-8 px-2.5 text-xs bg-white border border-slate-300 rounded-md outline-none transition focus:border-blue-500';
export const BTN_P =
  'inline-flex items-center justify-center gap-1.5 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-xs font-semibold px-3.5 h-8 rounded-lg transition disabled:opacity-50 cursor-pointer shadow-xs';
export const BTN_OK =
  'inline-flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white text-xs font-semibold px-3.5 h-8 rounded-lg transition disabled:opacity-50 cursor-pointer shadow-xs';
